                ...
                <div className="hidden md:flex items-center gap-8">
                    {navItems.map((item, index) => (
                        ...
                        >
                            ...
                            {/* Dropdown */}
                            <AnimatePresence>
                                {item.children && dropdownOpen && hoveredIndex === index && (
                                    <motion.div
                    ...
                    <div className="ml-4 flex items-center gap-2 text-sm font-medium">
                        ...
                        <span className="text-gray-400 hover:text-white transition-colors cursor-pointer">RU</span>
                    </div>
                </div>
                        ...
                        >
                            <div className="p-4 flex flex-col gap-4">
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-800 flex items-center gap-4">
                                    <span className="font-bold text-xl text-white">EN</span>
